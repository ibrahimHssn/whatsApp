...
import 'package:whatsappchat/%20feature/contact/controllers/contacts_controller.dart';
import 'package:whatsappchat/%20feature/contact/widget/contact_card.dart';
...
class ContactPage extends ConsumerWidget {
  ...
  shareSmsLink(phoneNumber)async{
    Uri sms=Uri.parse("sms:$phoneNumber?body=Let's chat on WhatsApp! it's a fast, simple, and secure app we can call each other for free. Get it at https://whatsAppchat.com/d1/");
              ...
              children: [
                if(index==0)
                   Padding(
                    ...
                    child: Text('Contacts on WhatsApp',style: TextStyle(fontWeight: FontWeight.w600,
              ...
              if(index==allContacts[0].length)
                Column(
                  ...
                  children: [
                    ...
                    myListTile(leading: Icons.contacts, text: 'New Contact',trailing: Icons.qr_code),
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 20,vertical: 10),
                      child: Text('Contacts on WhatsApp',style: TextStyle(fontWeight: FontWeight.w600,
                        color: context.theme.greyColor,
