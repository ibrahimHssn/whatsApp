        ...
        child:Column(
          children: [
            ...
            child: RichText(
              ...
              children:  [
                const TextSpan(
                  text: "You've tried to register +201226394351 before requesting an SmS or call with your code. "
                ),
                TextSpan(
                  text: "Wrong number?",style: TextStyle(color:context.theme.blueColor )
                )
              ]
            )),
            ),
            ...
            Container(
              ...
              child:  CustomTextField(
                hintText: "- - -  - - -",fontSize: 30,autoFocus: true,
